...
func init() {
	...
	rootCmd.PersistentFlags().BoolVarP(&keepaliveFlag, "keep-alive", "k", false, "true if the server will not be shutdown after the transfer, allowing multiple transfewrs")
